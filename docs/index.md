---
layout: default
title: Electron Reverse Engineering Skill
---
...
| # | Bölüm | Açıklama |
|:-:|-------|----------|
| 1 | [Ne Zaman Kullanılır](skill/SKILL.md#1-ne-zaman-kullan%C3%BCl%C3%BCr) | Hangi durumda hangi tekniğin kullanılacağı |
...
Bu skill **eğitim ve araştırma amaçlıdır**. Başkalarının yazılımlarını izinsiz değiştirmek, lisans ihlalleri yapmak veya kötü amaçlı kullanmak yasa dışı olabilir.
